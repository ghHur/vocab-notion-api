      ...
      <div className="header">
        <div className="header-inner">
          ...
          <div className="header-actions">
            ...
            {!isQuiz && !isFill && !isMatch && !isTagManager && words.length > 0 && (
              <button
                className="btn btn-outline"
                onClick={() => {
                  setTmSelectedTag("");
            ...
            {words.length >= 3 && !isQuiz && !isFill && !isMatch && !isTagManager && (
              <>
                <button
                  className="btn btn-outline"
                  onClick={() => {
            ...
            {view !== "add" && !isQuiz && !isFill && !isMatch && !isTagManager && (
              <button
                className="btn btn-primary"
                onClick={() => {
                  setFormTags([]);
